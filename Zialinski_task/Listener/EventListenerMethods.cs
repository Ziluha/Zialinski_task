...
{
    public class EventListenerMethods : BaseReport
    {
        ...
        {
            string logMessage = "Try to open page " + e.Driver.Title + " by URL: " + e.Url;
            Log.Info(logMessage);
        ...
        {
            string logMessage = "Opened page: " + e.Driver.Title + " by URL: " + e.Url;
            Log.Info(logMessage);
            Test.Log(Status.Pass, logMessage);
        }
